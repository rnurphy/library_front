...
public class AccountMailService {
    ...
    public boolean sendAuthMail() {
        ...
        try {
            MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, false, "UTF-8");  // 두번째 매개변수는 파일전송 여부
    ...
    public Map<String, Object> authenticate(String token) {
        ...
        try {
            ...
            if(roleRegister != null) {  // 5분 내에 여러번 요청 날렸을때
