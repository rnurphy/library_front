...
public class AuthService {
    ...
    public void signup(SignupReqDto signupReqDto) {
        ...
        if(successCount < 2) throw new SaveException();
    }
    ...
    public void oAuth2Signup(OAuth2SignupReqDto oAuth2SignupReqDto) {
        ...
        if(successCount < 3) throw new SaveException();
    }
    ...
    public void OAuth2Merge(OAuth2MergeReqDto oAuth2MergeReqDto) {
        ...
        if(!passwordEncoder.matches(oAuth2MergeReqDto.getPassword(), user.getPassword())) {  // ( raw, encoded )
            throw new BadCredentialsException("사용자 정보를 다시 확인하세요");
        }
